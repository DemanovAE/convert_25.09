...
calib_file1=${path_to_macro}/run8_dedx_calibR_coeff.root
calib_file2=${path_to_macro}/run8_dedx_calibS_coeff.root
pid_file1=${path_to_macro}/pars400_25.04.root
pid_file2=${path_to_macro}/pars700_25.04.root
vtxXYZ_corr_file=${path_to_macro}/run8_25.09_corr_VtxXYZ.root
bc1_fd_corr_file=${path_to_macro}/run8_25.09_corr_bc1fd.root
...
time root -l -b -q ${CONVERTER_MACRO}"(\"${input_file_dst}\", \"${input_file_digi}\",\"${calib_file1}\",\"${calib_file2}\",\"${output_file}\",\"${pid_file1}\",\"${pid_file2}\",\"${vtxXYZ_corr_file}\",\"${bc1_fd_corr_file}\")" &>> $output_log
